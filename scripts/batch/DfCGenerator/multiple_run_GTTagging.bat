...
REM -- x64_debug
REM -- x64_release
set CONFIGURATION_NAME=x86_debug

REM -- DEFINE PROJECT PATH
set PROJECT_PATH=G:\data\sebastianvilla139\work\projects\lifeclef2015\vs2010\DfCGenerator

REM -- DEFINE EXECUTABLE NAME
set EXEC_NAME=GTTagging.exe

REM -- DEFINE DATASET PATH
set DATASET_PATH=G:\data\sebastianvilla139\work\projects\lifeclef2015\dataset\videos
...
for %%s in (%DATASET_PATH%\*.flv) do %PROJECT_PATH%\%EXECUTABLE_PATH% %%s 0 1 0