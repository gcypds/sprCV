...
void gtrois::
fversion (::std::unique_ptr< fversion_type > x)
{
  this->fversion_.set (std::move (x));
}
...
void gtrois::
video_name (::std::unique_ptr< video_name_type > x)
{
  this->video_name_.set (std::move (x));
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< roi_type > r (
        roi_traits::create (i, f, this));

      this->roi_.push_back (::std::move (r));
      continue;
    }
...
::std::unique_ptr< ::gtrois >
gtrois_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
         ::xml_schema::flags f,
