...
typedef void (*bgsProgressCallbackFunction)(std::string label, int value, int total);
...
public:
	...
	void saveCodebookParametersPath(std::string codebook_parameters_path);

	//! set BGS progress callback function
	void setBGSProgressFunction(bgsProgressCallbackFunction function);

	// Path for saving codebooks parameters
	...
	bgsProgressCallbackFunction progressFunction;
	bool progressFunctionDefined;
protected:
