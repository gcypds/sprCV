...
void Input_source::Im_seq_sel()
{
	...
	case 12: std::cout<<"Select video from category: survmantics"<<std::endl;
		...
		std::cout<<"12) ShopAssistant"<<std::endl;
		std::cout<<"13) All videos"<<std::endl;
		std::cin>>vid_id;			//get selected video
		...
		case 11: vids_ids.push_back(vid_id);	//video identifier
			break;
		case 12: vids_ids.push_back(vid_id);	//video identifier
			break;
		default:
		case 13: for(int v=1; v<(vids_cat[cat_sel]+1); v++)
				{
					vids_ids.push_back(v);	//video identifier
				}
				break;
...
void Input_source::Im_seq_info(int cat_sel, int vid_id)
{
	...
	case 12:				
		switch(vid_id)	//switch through videos
		{		
		case 1: strcpy(imgpath,"D:\\People_Detection\\00001\\image0");
			strcpy(imgpathf,"D:\\People_Detection\\00001\\Fmask\\image0");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			break;
		case 2: strcpy(imgpath,"D:\\People_Detection\\00587\\image0");
			strcpy(imgpathf,"D:\\People_Detection\\00587\\Fmask\\image0");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			break;
		case 3: strcpy(imgpath,"D:\\People_Detection\\00945\\image0");
			strcpy(imgpathf,"D:\\People_Detection\\00945\\Fmask\\image0");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			inifr = 945;
			endfr = 1158;
			strcat(save_path,"D:\\Challenge_Surveillance\\originalDB\\00945\\SegIm");
			break;
		case 4: strcpy(imgpath,"D:\\People_Detection\\Videos\\survmantics04500\\image0");
			strcpy(imgpathf,"D:\\People_Detection\\04500\\Fmask\\image0");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			inifr = 4500;
			endfr = 4719;
			strcat(save_path,"D:\\Challenge_Surveillance\\originalDB\\04500\\SegIm");
			break;
		case 5: strcpy(imgpath,"D:\\People_Detection\\Videos\\survmantics22499\\image2");
			strcpy(imgpathf,"D:\\People_Detection\\22499\\Fmask\\image2");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			inifr = 2499;
			endfr = 2841;
			strcat(save_path,"D:\\Challenge_Surveillance\\originalDB\\22499\\SegIm");
			break;
		case 6: strcpy(imgpath,"D:\\People_Detection\\Videos\\survmantics37270\\image3");
			strcpy(imgpathf,"D:\\People_Detection\\37270\\Fmask\\image3");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			break;
		case 7: strcpy(imgpath,"D:\\People_Detection\\Videos\\survmantics48194\\image4");
			strcpy(imgpathf,"D:\\People_Detection\\48194\\Fmask\\F");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			break;
		case 8: strcpy(imgpath,"D:\\People_Detection\\Videos\\survmantics54202\\image5");
			strcpy(imgpathf,"D:\\People_Detection\\54202\\Fmask\\image5");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			break;
		case 9: strcpy(imgpath,"D:\\People_Detection\\Videos\\survmantics62012\\image6");
			strcpy(imgpathf,"D:\\People_Detection\\62012\\Fmask\\image6");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			break;
		case 10: strcpy(imgpath,"D:\\People_Detection\\70083\\image6");
			strcpy(imgpathf,"D:\\People_Detection\\Fmask\\image6");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			break;
		case 11: strcpy(imgpath,"D:\\People_Detection\\80120\\image8");
			strcpy(imgpathf,"D:\\People_Detection\\80120\\Fmask\\image8");
			strcat(gtpath,"dataset\\turbulence\\turbulence0\\groundtruth\\gt00");
			...
			break;
		case 12: strcpy(imgpath,"D:\\People_Detection\\Videos\\ShopAssistant\\frame");
			strcpy(vidname,"ShopAssistant");
			strcpy(ext,"png");
			inifr = 1;
			endfr = 1000;
			break;
